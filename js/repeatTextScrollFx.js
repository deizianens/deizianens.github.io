  ...
  layout() {
    ...
    for (let i = 0; i < this.totalWords; ++i) {
      ...
      if (i === this.totalWords - 1) {
        ...
        delay =
          this.delayIncrement * (halfWordsCount - i) - this.delayIncrement;
      } else {
        ty =
          -1 *
          (halfWordsCount * this.tyIncrement -
            (i - halfWordsCount) * this.tyIncrement);
        delay =
          this.delayIncrement * (halfWordsCount - (i - halfWordsCount)) -
          this.delayIncrement;
      }
